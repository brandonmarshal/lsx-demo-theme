...
> **How to use:**  
Replace bracketed or optional fields (e.g., logo upload) as needed. This guide covers colours, typography, layout, logo, dark theme, and voice & tone.
...
| Role       | Name/Theme      | HEX      | RGB         | CMYK        | Use                           | Contrast/Notes        |
|------------|-----------------|----------|-------------|-------------|-------------------------------|-----------------------|
...
| Accent     | Vegetation      | #556B2F  | 85,107,47   | 20,0,56,58  | Secondary accents, hover      | AA vs white           |
| Highlight  | Sunset/Adventure| #D35400  | 211,84,0    | 0,60,100,17 | CTA buttons, notifications    | AAA vs white          |
| Neutral    | N0–N900         | #FFFFFF → #1A1A1A | — | —         | Backgrounds, text, UI         | Tonal hierarchy       |
...
- **Source Inspiration:** Derived from Huttenspruit/KZN environment: rivers, rocks, vegetation, sunsets.
...
| Body                 | Lora        | 400 Regular / Italic| Humanist serif; comfortable reading | "Lora", Georgia, serif             |
| Quotes/Accents       | Lora Italic | 400 Italic         | Storytelling, species, anecdotes    | "Lora", Georgia, serif             |
...
- **Imagery:** Full-width, high-quality fishing/adventure photos.  
  Mix action shots (Brandon fishing) + close-ups (fish species). Subtle contrast, natural tones.
...
| Logo (dark)    | Inverted/light| [PATH]   | For dark backgrounds             |
...
**Do:**  
- Plain language, active verbs, sensory details

**Don’t:**  
- Jargon, over-selling, hype

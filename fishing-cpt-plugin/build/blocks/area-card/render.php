...
echo '<div class="area-card" role="group" aria-label="' . \esc_attr__('Area card', 'fishing-cpt-plugin') . '">';
echo '<h3 class="area-card__title">' . \esc_html(\get_the_title($post_id)) . '</h3>';
echo '<ul class="area-card__meta" role="list">';
if ($loc) {

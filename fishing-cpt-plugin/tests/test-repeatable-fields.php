...
class Test_Repeatable_Fields
{
	...
	public function test_field_group_functions_exist()
	{
		...
		$this->assertTrue(
			function_exists('FishingCPTPlugin\register_repeatable_fields'),
	...
	{
		$this->assertTrue(
			function_exists('FishingCPTPlugin\display_gear_specifications'),
			'Gear specifications helper should exist'
		);

		$this->assertTrue(
			function_exists('FishingCPTPlugin\display_fish_quick_facts'),
	...
	{
		$this->assertTrue(
			function_exists('FishingCPTPlugin\enqueue_repeatable_fields_assets'),
	...
	{
		ob_start();
		\FishingCPTPlugin\display_gear_specifications(1);
		$output = ob_get_clean();
	...
	{
		ob_start();
		\FishingCPTPlugin\display_fish_quick_facts(1);
		$output = ob_get_clean();

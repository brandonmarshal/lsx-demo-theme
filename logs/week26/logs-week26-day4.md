...
-  The AI in Figma is unbelievably dumb. It has zero logic at all and needs to be spoon fed absolutely everything. I spent 15 - 20 minutes trying to get it to add padding around a badge, which was extremely frustrating as it took me 10 seconds to copy it into a design file and then fix it and paste it back to the agent, even then the agent still got it wrong. 

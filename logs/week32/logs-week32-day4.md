...
-   The Hero sections on all services pages are basically images that I cannot adjust their colour, either we need to use a different background where I can apply my colour tokens, or we need to accept the darker images in Lightmode, I will discuss this with Zared to get his opinion as well.

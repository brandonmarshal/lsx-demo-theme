...
-   I am a little bit lost with what is needed. I know I must apply the new content to the pages as mentioned in the doc, but there are a few parts in the doc that I am not sure how they will be styled, do they go in cards, should I choose any component that I already created, or do we create new ones? Zared and I will discuss this in our meeting.
-   The meeting with Zared helped me clarify what is required. I need to do all the service pages using the same page template and using the content provided in the document by Ash.

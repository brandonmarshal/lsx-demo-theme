...
-   One blocker remaining before Default Primitives can be deleted: 278 canvas nodes (palette swatch/documentation frames) still have fills bound directly to Default Primitives
-   rebinding these is the final step before the collection can be safely removed

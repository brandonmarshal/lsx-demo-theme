...
/**
 * Title: Homepage BFA
 * Slug: lsx-demo-theme/homepage-bfa
 * Categories: Pages
 */
?>
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"http://localhost:8883/wp-content/themes/ollie/patterns/images/computer-hands.webp","dimRatio":0,"isDark":false,"className":"is-style-rounded-cover","style":{"dimensions":{"aspectRatio":"1"}}} -->
<div class="wp-block-cover is-light is-style-rounded-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background " alt="Hands typing on computer" src="http://localhost:8883/wp-content/themes/ollie/patterns/images/computer-hands.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
<p class="has-text-align-center"></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column --></div>
...
<!-- wp:cover {"url":"http://localhost:8883/wp-content/themes/ollie/patterns/images/guy-laptop.webp","hasParallax":true,"dimRatio":90,"overlayColor":"primary","isUserOverlayColor":true,"minHeight":50,"metadata":{"name":"Text Boxes"},"align":"full","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
<div class="wp-block-cover alignfull has-parallax" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:50px"><span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-90 has-background-dim"></span><div class="wp-block-cover__image-background  has-parallax" style="background-position:50% 50%;background-image:url(http://localhost:8883/wp-content/themes/ollie/patterns/images/guy-laptop.webp)"></div><div class="wp-block-cover__inner-container"><!-- wp:group {"metadata":{"name":"Text Boxes Inside"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large","right":"var:preset|spacing|medium","left":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}}},"textColor":"base","layout":{"type":"constrained"}} -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="http://localhost:8883/wp-content/themes/ollie/patterns/images/avatar-4.webp" alt="Testimonial author avatar" class="" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"60px","height":"60px","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="http://localhost:8883/wp-content/themes/ollie/patterns/images/avatar-1.webp" alt="Testimonial author avatar" class="" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"60px","height":"60px","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="http://localhost:8883/wp-content/themes/ollie/patterns/images/avatar-5.webp" alt="Testimonial author avatar" class="" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"60px","height":"60px","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="http://localhost:8883/wp-content/themes/ollie/patterns/images/avatar-2.webp" alt="Testimonial author avatar" class="" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group alignfull has-tertiary-background-color has-background" style="margin-top:0px;margin-bottom:0px;padding-top:var(--wp--preset--spacing--xx-large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--xx-large);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|x-large","left":"var:preset|spacing|x-large"},"margin":{"top":"0px","bottom":"0px"}}}} -->
<div class="wp-block-columns alignwide are-vertically-aligned-center" style="margin-top:0px;margin-bottom:0px"><!-- wp:column {"verticalAlignment":"center"} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"http://localhost:8883/wp-content/themes/ollie/patterns/images/guy-laptop.webp","dimRatio":0,"customOverlayColor":"#dddddb","isUserOverlayColor":true,"minHeightUnit":"px","isDark":false,"className":"is-style-rounded-cover","style":{"dimensions":{"aspectRatio":"1"}}} -->
<div class="wp-block-cover is-light is-style-rounded-cover"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#dddddb"></span><img class="wp-block-cover__image-background " alt="Person using a laptop" src="/wp-content/themes/ollie/patterns/images/guy-laptop.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
<p class="has-text-align-center"></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="http://localhost:8883/wp-content/themes/ollie/patterns/images/avatar-3.webp" alt="" class="" style="width:75px;height:75px"/></figure>
<!-- /wp:image -->

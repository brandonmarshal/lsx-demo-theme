<?php
/**
 * Title: Ollie Mobile Menu 1
 * Slug: fishing-theme/ollie-mobile-menu-1
 * Categories: Menu
 */
?>
...
<div class="wp-block-group"><!-- wp:image {"width":"75px","aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":"100px"}}} -->
<figure class="wp-block-image size-large is-resized has-custom-border"><img src="http://brandonlightspeedwpdev.local/wp-content/themes/ollie/patterns/images/avatar-3.webp" alt="" class="" style="border-radius:100px;aspect-ratio:1;object-fit:cover;width:75px"/></figure>
<!-- /wp:image -->

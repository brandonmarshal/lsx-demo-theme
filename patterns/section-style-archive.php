...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--spacing-70);padding-right:var(--wp--preset--spacing--spacing-50);padding-bottom:var(--wp--preset--spacing--spacing-70);padding-left:var(--wp--preset--spacing--spacing-50)">
	...
	<h2 class="wp-block-heading has-text-align-center has-h-2-font-size"><?php esc_html_e( 'Featured Fish Species', 'lsx-demo-theme' ); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|spacing-60"}}}} -->
	<p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--spacing-60)"><?php esc_html_e( 'Discover the diverse species found in KwaZulu-Natal\'s waters.', 'lsx-demo-theme' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns alignwide is-style-fishing-archive-grid">
		...
		<div class="wp-block-column" style="border-color:var(--wp--preset--color--muted);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--spacing-50);padding-right:var(--wp--preset--spacing--spacing-40);padding-bottom:var(--wp--preset--spacing--spacing-50);padding-left:var(--wp--preset--spacing--spacing-40)">
			...
			<h3 class="wp-block-heading has-h-3-font-size"><?php esc_html_e( 'Largemouth Bass', 'lsx-demo-theme' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"body"} -->
			<p class="has-body-font-size"><?php esc_html_e( 'Popular sport fish known for aggressive strikes and fighting spirit.', 'lsx-demo-theme' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size"><a href="#"><?php esc_html_e( 'Learn More →', 'lsx-demo-theme' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-color:var(--wp--preset--color--muted);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--spacing-50);padding-right:var(--wp--preset--spacing--spacing-40);padding-bottom:var(--wp--preset--spacing--spacing-50);padding-left:var(--wp--preset--spacing--spacing-40)">
			<!-- wp:heading {"level":3,"fontSize":"h3"} -->
			<h3 class="wp-block-heading has-h-3-font-size"><?php esc_html_e( 'Smallmouth Yellowfish', 'lsx-demo-theme' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"body"} -->
			<p class="has-body-font-size"><?php esc_html_e( 'Native species prized for their strength and beauty in river systems.', 'lsx-demo-theme' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-column" style="border-color:var(--wp--preset--color--muted);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--spacing-50);padding-right:var(--wp--preset--spacing--spacing-40);padding-bottom:var(--wp--preset--spacing--spacing-50);padding-left:var(--wp--preset--spacing--spacing-40)">
			<!-- wp:heading {"level":3,"fontSize":"h3"} -->
			<h3 class="wp-block-heading has-h-3-font-size"><?php esc_html_e( 'Tigerfish', 'lsx-demo-theme' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"fontSize":"body"} -->
			<p class="has-body-font-size"><?php esc_html_e( 'Fierce predator offering thrilling battles for experienced anglers.', 'lsx-demo-theme' ); ?></p>
			<!-- /wp:paragraph -->

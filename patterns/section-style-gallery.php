...
<div class="wp-block-group alignfull is-style-fishing-gallery-section has-text-color has-surface-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--spacing-85);padding-right:var(--wp--preset--spacing--spacing-50);padding-bottom:var(--wp--preset--spacing--spacing-85);padding-left:var(--wp--preset--spacing--spacing-50)">
	...
	<p class="has-text-align-center"><?php esc_html_e( 'Explore our collection of memorable fishing moments and trophy catches from rivers across KZN.', 'lsx-demo-theme' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<figure class="wp-block-gallery alignwide has-nested-images columns-3 is-cropped">
		...
		<figure class="wp-block-image size-large"><img alt="<?php esc_attr_e( 'Largemouth bass catch', 'lsx-demo-theme' ); ?>"/></figure>
		<!-- /wp:image -->

		<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large"><img alt="<?php esc_attr_e( 'Smallmouth bass catch', 'lsx-demo-theme' ); ?>"/></figure>
		<!-- /wp:image -->

		<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large"><img alt="<?php esc_attr_e( 'Yellowfish catch', 'lsx-demo-theme' ); ?>"/></figure>
		<!-- /wp:image -->
	</figure>
	<!-- /wp:gallery -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--spacing-60)">
		<!-- wp:button -->
		<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'View Full Gallery', 'lsx-demo-theme' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>

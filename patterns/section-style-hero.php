...
<div class="wp-block-group alignfull is-style-fishing-hero has-heading-color has-river-blue-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--spacing-95);padding-right:var(--wp--preset--spacing--spacing-60);padding-bottom:var(--wp--preset--spacing--spacing-95);padding-left:var(--wp--preset--spacing--spacing-60)">
	...
	<h1 class="wp-block-heading has-text-align-center has-h-1-font-size"><?php esc_html_e( 'Explore River Fishing Adventures', 'fishing-theme' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","fontSize":"lead"} -->
	<p class="has-text-align-center has-lead-font-size"><?php esc_html_e( 'Discover pristine waters, abundant fish species, and unforgettable experiences across KwaZulu-Natal\'s premier fishing destinations.', 'fishing-theme' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--spacing-60)">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-background-color has-burnt-orange-background-color has-text-color has-background wp-element-button"><?php esc_html_e( 'Book Your Trip', 'fishing-theme' ); ?></a></div>
		<!-- /wp:button -->

		<!-- wp:button {"className":"is-style-outline"} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'View Fishing Reports', 'fishing-theme' ); ?></a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
